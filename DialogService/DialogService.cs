...
namespace Boxy_Core.DialogService
{
    /// <summary>
    ...
    public class DialogService : IDialogService
    {
            ...
            where TViewModel : IDialogRequestClose
        {
            ...
            if (Activator.CreateInstance(viewType) is not IDialog dialog)
            {
                throw new InvalidCastException($"Could not create default instance of {typeof(IDialog)} using Activator.CreateInstance().");
            }
