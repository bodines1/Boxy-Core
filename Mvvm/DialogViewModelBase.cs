...
namespace Boxy_Core.Mvvm
{
    ...
    public class DialogViewModelBase : ViewModelBase, IDialogRequestClose
    {
        ...
        public RelayCommand OkDialog
        {
            get
            {
                return _okDialog ??= new RelayCommand(OkDialog_Execute, OkDialog_CanExecute);
            }
        }
        ...
        public RelayCommand CancelDialog
        {
            get
            {
                return _cancelDialog ??= new RelayCommand(CancelDialog_Execute, CancelDialog_CanExecute);
            }
        }
